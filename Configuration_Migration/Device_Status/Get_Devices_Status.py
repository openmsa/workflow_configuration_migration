...
if MS_list_not_run:    
  MSA_API.task_success('DONE: for devices status for ' + ' and '.join(devices.keys()) + ', but can not get status for (' + MS_list_not_run + ') but get the status for ('+MS_list_run+')' , context, True)
else:
